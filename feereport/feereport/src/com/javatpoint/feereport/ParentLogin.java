...
public class ParentLogin extends JFrame {
	...
	public ParentLogin() {
		...
		JLabel lblAccountantLogin = new JLabel("Parent Login");
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			boolean status=AccountantDao.validateParent(name, password);
			if(status){
				ParentSection.main(new String[]{});
				frame.dispose();
			}else{
				JOptionPane.showMessageDialog(ParentLogin.this,"Sorry, username or password error!","Login error!",JOptionPane.ERROR_MESSAGE);
			}
			}
		});
